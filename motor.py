...
from bricknil.sensor.peripheral import Peripheral
...
class TechnicControlPlusXL(Motor):
    _sensor_id = 0x002F

class TechnicControlPlusLargeMotor(Motor):
    _sensor_id = 0x002E

class TechnicControlWithMacho(Motor):
    _sensor_id = 0x0026
